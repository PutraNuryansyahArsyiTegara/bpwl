...
<?php 
    ...
    $result = mysqli_query($conn, "SELECT Monthname(bulan) as bulan, jumlahPendaftar,jumlahDiterima FROM penerimaan ORDER BY Monthname(bulan) DESC");
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Grafik Pendaftaran Mahasiswa PCR 2020',
